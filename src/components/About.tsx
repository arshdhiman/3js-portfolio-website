      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto leading-relaxed font-medium">
            ...
            applications, APIs, and integrating third-party services. I focus on
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {highlights.map((item, index) => (
            <motion.div
              ...
              className="group bg-card/80 backdrop-blur-sm p-8 rounded-2xl border border-border/50 text-center hover:bg-card/90 hover:border-border hover:shadow-2xl transition-all"
            >
              <div
                className={`text-primary mb-4 flex justify-center ${
                  hoveredCard === index ? "scale-125 animate-bounce-slow" : ""
                }`}
              >
                {item.icon}
              </div>
