  ...
  const projects = [
    {
      ...
      description: "A video interactive education platform aimed at enhancing classroom experiences with real-time streaming and interactive features.",
      technologies: ["Node.js", "Express.js", "MongoDB", "React.js", "Docker", "AWS", "Socket.io", "Jest"],
      achievements: [
    ...
    {
      title: "Stream Rebels",
      description: "A video-streaming platform tailored for the electronic music community with live streaming capabilities and real-time interaction.",
    ...
    {
      title: "Multiverz",
      description: "A platform allowing users to create and participate in challenges to showcase skills with gamification elements.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto font-medium">
            Innovative solutions that showcase technical expertise and problem-solving skills
          </p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-semibold text-green-600 dark:text-green-400 mb-3">KEY ACHIEVEMENTS</h4>
